...
import kr.co.tjeit.weathertestapp.R;
		...
		if (isNetworkAvailable(context)) {
			AsyncTaskHandler async = new AsyncTaskHandler() {
				...
				public String doInBackground() {
					...
					if (params == null)
						return HttpRequest.get(url).header("appkey","6d1cbfaa-b966-3227-a57b-94ce51d456d2").body();
					else
						return HttpRequest.get(url).header("appkey","6d1cbfaa-b966-3227-a57b-94ce51d456d2").form(params).body();
				}
			};
